...
ADDI $r7, $r0, 5        # r7 = constant 10
ADDI $r6, $r0, 415      # r6 = constant 400 + 25 - 5 - 5
ADDI $r2, $r0, 6        # skip top border
ADDI $r3, $r0, 19       # skip bottom border
BEQ $r2, $r3, 26        # jump to end if inside border
LOAD $r4, 0($r2)        # load pixel colour as r4
BEQ $r4, $r0, 24        # jump to increment if black
SUBI $r5, $r2, 5        # set r5 to pixel above
LOAD $r4, 0($r5)        # load above pixel colour as r4
BEQ $r4, $r0, 24        # jump to increment if black
ADDI $r5, $r2, 5        # set r5 to pixel below
