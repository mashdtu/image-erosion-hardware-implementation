...
STORE   $r0,        0($r6)                  # 5. Make the current pixel black in the output image
...
LOAD    $r2,        0($r1)                  # 9. Load the new pixel colour
...
LOAD    $r2,        0($r5)                  # 24. If left pixel is black, make current black and skip to next
BEQ     $r2,        $r0,        3           # 25. 
ADDI    $r5,        $r5,        2           # 26. Select pixel to the right
LOAD    $r2,        0($r5)                  # 27. If right pixel is black, make current black and skip to next
BEQ     $r2,        $r0,        3           # 28.
...
LOAD    $r2,        0($r5)                  # 34. If below pixel is black, make current black and skip to next
BEQ     $r2,        $r0,        3           # 35. 
...
STORE   $r7,        0($r6)                  # 39. Make the current pixel white in the output image
