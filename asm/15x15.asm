...
ADDI $r7, $r0, 15       # r7 = constant 15
ADDI $r6, $r0, 595      # r6 = constant 400 + 225 - 15 - 15
ADDI $r2, $r0, 16       # skip top border
ADDI $r3, $r0, 209      # skip bottom border
BEQ $r2, $r3, 26        # jump to end if inside border
LOAD $r4, 0($r2)        # load pixel colour as r4
BEQ $r4, $r0, 24        # jump to increment if black
SUBI $r5, $r2, 15       # set r5 to pixel above
LOAD $r4, 0($r5)        # load above pixel colour as r4
BEQ $r4, $r0, 24        # jump to increment if black
ADDI $r5, $r2, 15       # set r5 to pixel below
